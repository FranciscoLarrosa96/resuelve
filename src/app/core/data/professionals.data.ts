...
const PRO_MOCKS: Omit<Professional, 'services'>[] = [
  ...
  },
  {
    ...
    photoUrl: photo('men/45'), trade: 'Electricista matriculado', categories: ['Electricidad'],
  ...
  },
  {
    ...
    photoUrl: photo('men/22'), trade: 'Electricista', categories: ['Electricidad'],
  ...
  },
  {
    ...
    photoUrl: photo('men/52'), trade: 'Plomero y gasista matriculado', categories: ['Plomería', 'Gas'],
  ...
  },
  {
    ...
    photoUrl: photo('men/36'), trade: 'Plomero', categories: ['Plomería'],
  ...
  },
  {
    ...
    photoUrl: photo('men/61'), trade: 'Plomería y destapaciones', categories: ['Plomería', 'Destapaciones'],
  ...
  },
  {
    ...
    photoUrl: photo('men/41'), trade: 'Plomero y gasista matriculado', categories: ['Plomería', 'Gas'],
  ...
  },
  {
    ...
    photoUrl: photo('men/15'), trade: 'Plomero', categories: ['Plomería'],
  ...
  },
  {
    ...
    photoUrl: photo('men/67'), trade: 'Gasista matriculado', categories: ['Gas'],
  ...
  },
  {
    ...
    photoUrl: photo('men/11'), trade: 'Cerrajero', categories: ['Cerrajería'],
  ...
  },
  {
    ...
    photoUrl: photo('men/75'), trade: 'Cerrajero', categories: ['Cerrajería'],
  ...
  },
  {
    ...
    photoUrl: photo('women/44'), trade: 'Pintora de interiores', categories: ['Pintura'],
  ...
  },
  {
    ...
    photoUrl: photo('men/81'), trade: 'Albañil', categories: ['Albañilería'],
