  ...
  template: `
    <div class="mx-auto max-w-2xl animate-fade-in px-4 pt-5.5 pb-6 lg:max-w-3xl lg:px-8 lg:pt-12 lg:pb-18">
      <div class="flex items-center gap-3.5 px-1">
        <div
          class="flex size-15 items-center justify-center rounded-[20px] bg-[#F6E3D3] font-display text-xl font-bold text-[#8A4A1E] lg:size-20 lg:rounded-3xl lg:text-2xl"
          aria-hidden="true"
        >{{ user.initials }}</div>
        <div>
      ...
      <div class="mt-5.5 grid gap-3.5 lg:mt-8 lg:grid-cols-[minmax(0,1fr)_280px] lg:items-start lg:gap-5">
        <ul class="overflow-hidden rounded-[20px] border border-line bg-white">
        ...
        <div class="rounded-[20px] bg-brand p-4.5 text-white">
          ...
          <a routerLink="/pro" class="mt-3.5 inline-flex h-11.5 items-center rounded-[14px] bg-white px-4.5 text-[14.5px] font-semibold text-brand">
